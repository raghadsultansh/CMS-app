...
class _Cs252WidgetState extends State<Cs252Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'CS252'});
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CS252_PAGE_arrow_back_rounded_ICN_ON_TAP');
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('CS252_PAGE_START_QUIZ_BTN_ON_TAP');
                  ...
                  child: Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CS252_PAGE_READ_ARTICLE_BTN_ON_TAP');
                          logFirebaseEvent('Button_navigate_to');
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('CS252_PAGE_WATCH_VIDEO_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                        Navigator.push(
                          context,
                          MaterialPageRoute(

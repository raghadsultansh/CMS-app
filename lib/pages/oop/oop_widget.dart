...
export 'oop_model.dart';

class OopWidget extends StatefulWidget {
  const OopWidget({Key? key}) : super(key: key);

  @override
  _OopWidgetState createState() => _OopWidgetState();
}

class _OopWidgetState extends State<OopWidget> {
  late OopModel _model;

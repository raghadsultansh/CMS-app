...
import 'awardpage_c_s252_model.dart';
export 'awardpage_c_s252_model.dart';

class AwardpageCS252Widget extends StatefulWidget {
  const AwardpageCS252Widget({super.key});

  @override
  State<AwardpageCS252Widget> createState() => _AwardpageCS252WidgetState();
}

class _AwardpageCS252WidgetState extends State<AwardpageCS252Widget>
    with TickerProviderStateMixin {
  late AwardpageCS252Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AwardpageCS252Model());
  }

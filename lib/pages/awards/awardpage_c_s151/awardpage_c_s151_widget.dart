...
import 'awardpage_c_s151_model.dart';
export 'awardpage_c_s151_model.dart';

class AwardpageCS151Widget extends StatefulWidget {
  const AwardpageCS151Widget({super.key});

  @override
  State<AwardpageCS151Widget> createState() => _AwardpageCS151WidgetState();
}

class _AwardpageCS151WidgetState extends State<AwardpageCS151Widget>
    with TickerProviderStateMixin {
  late AwardpageCS151Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AwardpageCS151Model());
  }

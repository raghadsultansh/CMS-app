...
import 'c_s252_article_model.dart';
export 'c_s252_article_model.dart';

class CS252ArticleWidget extends StatefulWidget {
  const CS252ArticleWidget({Key? key}) : super(key: key);

  @override
  _CS252ArticleWidgetState createState() => _CS252ArticleWidgetState();
}

class _CS252ArticleWidgetState extends State<CS252ArticleWidget> {
  late CS252ArticleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CS252ArticleModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CS252_Article'});
  }
                        ...
                        children: [
                          Align(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'C_S252_ARTICLE_arrow_back_rounded_ICN_ON');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'C_S252_ARTICLE_PAGE_READ_BTN_ON_TAP');

...
import 'c_s151_quiz_model.dart';
export 'c_s151_quiz_model.dart';

class CS151QuizWidget extends StatefulWidget {
  const CS151QuizWidget({Key? key}) : super(key: key);

  @override
  _CS151QuizWidgetState createState() => _CS151QuizWidgetState();
}

class _CS151QuizWidgetState extends State<CS151QuizWidget> {
  late CS151QuizModel _model;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'Lesson 1: Understanding OOP Basics',
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      12.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    'Lesson 6: OOP Principles in Practice',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Poppins',
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      12.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    'Lesson 7: OOP in Different Programming Languages',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Poppins',

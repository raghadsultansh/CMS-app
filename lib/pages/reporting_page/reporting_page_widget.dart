...
import 'reporting_page_model.dart';
export 'reporting_page_model.dart';

class ReportingPageWidget extends StatefulWidget {
  const ReportingPageWidget({Key? key}) : super(key: key);

  @override
  _ReportingPageWidgetState createState() => _ReportingPageWidgetState();
}
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-0.91, -1.02),

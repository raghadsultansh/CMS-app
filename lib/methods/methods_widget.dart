...
import 'methods_model.dart';
export 'methods_model.dart';

class MethodsWidget extends StatefulWidget {
  const MethodsWidget({Key? key}) : super(key: key);

  @override
  _MethodsWidgetState createState() => _MethodsWidgetState();
}

class _MethodsWidgetState extends State<MethodsWidget> {
  late MethodsModel _model;
